<html>
  ...
  <body class="container text-center">
    ...
    $sql2 = "SELECT * FROM orders WHERE  day_inserted = '".$result["id_isopened"]."'";
    ...
    echo "
    <h2 class=\"mt-4 text-center\" width=30%>Vendas do dia:</h2>
    <table class=\"w-100 text-center border \">
    <tr style=\"background: #cecece\">
    <th class=\"border-right\" width=30%>ID da venda</th>
    <th width=30%>status</th>
    <th width=30%>Total da venda</th>
    <th width=10%></th>
    </tr>
    ";
    ...
    <a href=\"./detailOrder.php?id_order=".$result[$key]['id_order']."&total=$num_order\"> detalhes <a></th>
    </tr>
    ";
